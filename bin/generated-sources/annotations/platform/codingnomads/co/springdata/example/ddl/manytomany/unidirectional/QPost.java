...
public class QPost extends EntityPathBase<Post> {
    ...
    private static final long serialVersionUID = -2069934849L;
    ...
    public final SetPath<Location, QLocation> location = this.<Location, QLocation>createSet("location", Location.class, QLocation.class, PathInits.DIRECT2);
